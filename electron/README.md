# UniAPI Electron Desktop App

This directory contains the Electron wrapper for UniAPI, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., uniapi-macos)
cp ../uniapi-macos ../uniapi
```
...
- Store database in `../data/uniapi.db`
...
### Database Location
- **Development**: `../data/uniapi.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/UniAPI/data/`
  - Windows: `%APPDATA%/UniAPI/data/`
  - Linux: `~/.config/UniAPI/data/`
