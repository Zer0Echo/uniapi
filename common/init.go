...
func printHelp() {
	fmt.Println("UniAPI " + Version + " - The next-generation LLM gateway and AI asset management system.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: Zer0Echo - https://github.com/Zer0Echo/uniapi")
	fmt.Println("Usage: uniapi [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
